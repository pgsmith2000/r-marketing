...
- then setup p1price by sampling a set of 5 prices and replacing the values
...
follow logarithmic function rather than linear not assuming prices 
vary inversely - proce of prod1 goes up as price of prod2 is lower
